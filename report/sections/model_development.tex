...
\lstinputlisting[language=Python,caption = First fully connected layer, flexiblecolumns=true, firstline=657, lastline=667]{../src/rnn.py}
...
\lstinputlisting[language=Python,caption = Second fully connected layer, flexiblecolumns=true, firstline=669, lastline=678]{../src/rnn.py}
...
\lstinputlisting[language=Python,caption = BiRNN Layer, flexiblecolumns=true, firstline=694, lastline=704]{../src/rnn.py}
...
\lstinputlisting[language=Python,caption = BiRNN Layer, flexiblecolumns=true, firstline=712, lastline=719]{../src/rnn.py}
...
\lstinputlisting[language=Python,caption = Third fully connected layer, flexiblecolumns=true, firstline=726, lastline=735]{../src/rnn.py}
...
\lstinputlisting[language=Python,caption = Output layer, firstline=737, lastline=746]{../src/rnn.py}