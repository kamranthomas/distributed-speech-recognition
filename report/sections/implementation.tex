...
\lstinputlisting[language=Python, flexiblecolumns=true, caption=Folder navigator. , firstline=37, lastline=51]{../src/FlacToWavPy.py}
...
\lstinputlisting[language=Python, flexiblecolumns=true, caption=Flac to wav conversion. , firstline=25, lastline=35]{../src/FlacToWavPy.py}
...
\lstinputlisting[language=Python, flexiblecolumns=true, caption=Text file check. , firstline=13, lastline=22]{../src/txtFileMaker.py}
...
\lstinputlisting[language=Python, flexiblecolumns=true, caption=Text file parsing. , firstline=36, lastline=51]{../src/txtFileMaker.py} 
...
\lstinputlisting[language=Python, flexiblecolumns=true, caption=Server receiving file., firstline=30, lastline=35]{../src/serverPy.py} 
...
\lstinputlisting[language=Python, flexiblecolumns=true, caption=New process., firstline=39, lastline=40]{../src/serverPy.py}
